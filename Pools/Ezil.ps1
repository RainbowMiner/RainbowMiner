...
param(
    ...
    [Bool]$EnableSrbminerMultiDual = $false,
...
if (((-not $EnableNanominerDual -and -not $EnableLolminerDual -and -not $EnableTrexDual -and -not $EnableSrbminerMultiDual -and -not $Pool_Currencies) -or -not $Wallets.ZIL) -and -not $InfoOnly) {return}
...
$Pools_Data | Where-Object {$EnableNanominerDual -or $EnableLolminerDual -or $EnableTrexDual -or $EnableSrbminerMultiDual -or $Wallets."$($_.symbol)" -or $InfoOnly} | ForEach-Object {
    ...
    foreach($Pool_Region in $Pool_Regions) {
        ...
        foreach($Pool_Port in $Pool_Ports) {
            ...
            if ($EnableNanominerDual -or $EnableLolminerDual -or $EnableTrexDual -or $EnableSrbminerMultiDual) {
                [PSCustomObject]@{
