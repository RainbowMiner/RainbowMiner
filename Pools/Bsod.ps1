...
$Pool_MiningCurrencies = @($PoolCoins_Request | Get-Member -MemberType NoteProperty -ErrorAction Ignore | Select-Object -ExpandProperty Name) | Select-Object -Unique | Where-Object {$PoolCoins_Request.$_.symbol -and ((Get-Variable $PoolCoins_Request.$_.symbol -ValueOnly -ErrorAction SilentlyContinue) -or $InfoOnly)}
