...
$Pool_Request.crypto.PSObject.Properties.Name | Where-Object {$_ -notin @("BTC","DGB","DOGE","PYI","UBQ") -and ($Wallets.$_ -or ($Email -ne "" -and $_ -notin $Pool_ExcludeMineToAccount) -or $InfoOnly)} | ForEach-Object {
