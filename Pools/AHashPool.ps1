...
try {
    $Pool_Request = Invoke-RestMethodAsync "http://www.ahashpool.com/api/status" -retry 3 -retrywait 500
    $PoolCoins_Request = Invoke-RestMethodAsync "http://www.ahashpool.com/api/currencies" -retry 3 -retrywait 750
}
catch {
