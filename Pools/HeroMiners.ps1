...
$Pools_Data = @(
    ...
    [PSCustomObject]@{coin = "Scala";         symbol = "XLA";   algo = "DevyX";       port = 10130; fee = 0.9; rpc = "scala"}
    [PSCustomObject]@{coin = "Scala";         symbol = "XTC";   algo = "DevyX";       port = 10130; fee = 0.9; rpc = "scala"}
