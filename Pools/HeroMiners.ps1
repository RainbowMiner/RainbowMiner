...
$Pool_AllRegions | Foreach-Object {
    $Region = Switch ($_) {
        "us" {"uswest"}
        "us2" {"useast"}
        "us3" {"ussouth"}
...
$Pools_Data = @(
    [PSCustomObject]@{symbol = "ALPH";  port = 1220; fee = 0.0; rpc = "alephium"; region = $Pool_AllRegions; pass = "x"}
    ...
    [PSCustomObject]@{symbol = "PRL";   port = 1200; fee = 0.0; rpc = "pearl"; region = $Pool_AllRegions}
