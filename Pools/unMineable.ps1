...
$Pools_Data = @(
    ...
    [PSCustomObject]@{algo = "pyrinhash";  port = @(3333,4444); ethproxy = $null;          rpc = "pyrinhash";  divisor = 1;   mh = 1e9; region = @("us","ca","eu","asia")}
    ...
    [PSCustomObject]@{algo = "xelishash";  port = @(3333,4444); ethproxy = $null;          rpc = "xelishash";  divisor = 1;   mh = 1e4; region = @("us","ca","eu","asia")}
