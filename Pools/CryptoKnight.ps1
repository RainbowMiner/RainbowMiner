...
$Pools_Data = @(
    ...
    [PSCustomObject]@{coin = "TurtleCoin"; symbol = "TRTL"; algo = "CnLiteV7"; port = 4901; fee = 0.0; walletSymbol = "turtle"; host = "turtle.ingest.cryptoknight.cc"}
