...
function Start-SubProcessInConsole {
    ...
    $Job = Start-Job -ArgumentList $PID, (Resolve-Path ".\Includes\cs\CreateProcess.cs"), $FilePath, $ArgumentList, $WorkingDirectory, $LogPath, $EnvVars {
        param($ControllerProcessID, $CreateProcessPath, $FilePath, $ArgumentList, $WorkingDirectory, $LogPath, $EnvVars)
