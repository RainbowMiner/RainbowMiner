        ...
        Switch($Mode) {
            ...
            "Pools" {
                $OutStat | Add-Member -NotePropertyMembers @{
                    ...
                    ErrorRatio         = [Decimal](1+$(if ($Stat.Actual24h_Week -and $Stat.Estimate_Week) {($Stat.Actual24h_Week/$Stat.Estimate_Week-1) * $(if ($Stat.Duration.TotalDays -lt 7) {$Stat.Duration.TotalDays*$Stat.Duration.TotalDays/49} else {1})}))
                }
            }
        }
