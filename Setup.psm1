...
function Start-Setup {
    ...
    do {
        ...
        elseif (@("W","C","E","S","A","N") -contains $SetupType) {
            ...
            Switch ($SetupType) {
                "W" {$GlobalSetupName = "Wallet";$GlobalSetupSteps.AddRange(@("wallet","nicehash","nicehash2","nicehashplatform","nicehashapiid","nicehashapikey","nicehashapisecret","mph","mphapiid","mphapikey","mrr","mrrapikey","mrrapisecret")) > $null}
