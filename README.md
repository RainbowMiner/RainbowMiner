...
- **Profit auto-switch between pools (AHashPool, BlazePool, BlockCruncher, BlockMasters, Bsod, Ethermine, HashRefinery, MiningPoolHub, Nanopool, Nicehash, PhiPhiPool, Ravenminer, YiiMP, ZergPool and Zpool)**
...
3. Update GPU drivers: [Nvidia 416.16](https://www.nvidia.com/Download/index.aspx) and [AMD Adrenaline 18.9.3](https://support.amd.com/en-us/download/desktop?os=Windows+10+-+64)
...
<details><summary>Valid poolnames</summary>ahashpool, ahashpoolcoins, blazepool, blockcruncher, blockmasters, blockmasterscoins, bsod, ethermine, hashrefinery, miningpoolhub, miningpoolhubcoins, miningpoolhubmini, nanopool, nicehash, nlpool, phiphipool, ravenminer, yiimp, zergpool, zergpoolcoins, zpool, zpoolcoins</details>
