...
<details><summary>Equipool</summary> https://equipool.1ds.us/ no auto-exchange, a separate wallet address is needed for each coin you want to mine. Set in pools configuration or edit pools.config.txt</details>
