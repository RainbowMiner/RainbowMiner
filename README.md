...
1. Install PowerShell 7: [Download Installer for version 7.2.3](https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/PowerShell-7.2.3-win-x64.msi)
...
Find the matching version of [Powershell Core v7.2.3 for your system from here](https://github.com/PowerShell/PowerShell/releases) and download it to your machine.
...
On Linux: either use the GUI installer to install the package or do it manually, e.g. for Ubuntu:
    ...
    wget https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/powershell-lts_7.2.3-1.deb_amd64.deb
    #wget https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/powershell_7.2.3-1.deb_amd64.deb

    # install powershell package (use the "-lts" for LTS Linux or the second line for non-LTS)
    dpkg -i powershell-lts_7.2.3-1.deb_amd64.deb
    #dpkg -i powershell_7.2.3-1.deb_amd64.deb
