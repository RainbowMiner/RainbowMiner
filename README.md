...
The new numbers (16x5, 20x9, ..) describe the number of bits matched in each round for the algorithm, and provide a relative measure of the â€œhardnessâ€ of the algorithm (the numbers can be calculated, using n and k: n/(k+1) )
