...
1. Install PowerShell 7: [Download Installer for version 7.2.1](https://github.com/PowerShell/PowerShell/releases/download/v7.2.1/PowerShell-7.2.1-win-x64.msi)
...
Find the matching version of [Powershell Core v7.2.1 for your system from here](https://github.com/PowerShell/PowerShell/releases) and download it to your machine.
...
On Linux: either use the GUI installer to install the package or do it manually, e.g. for Ubuntu:
    ...
    wget https://github.com/PowerShell/PowerShell/releases/download/v7.2.1/powershell_7.2.1-1.ubuntu.18.04_amd64.deb

    # install powershell package
    dpkg -i powershell_7.2.1-1.ubuntu.18.04_amd64.deb
...
<details><summary>Valid poolnames</summary>2Miners, 2MinersAE, 2MinersSolo, 6Block, Acepool, Aionmine, BaikalMine, BaikalMineSolo, Binance, BlockMasters, BlockMastersCoins, Bsod, BsodParty, BsodSolo, BtcPrivate, C3pool, Cortexmint, CpuPool, Crazypool, EthashPool, Ethermine, Ezil, F2pool, FairPool, FlexPool, FlockPool, FluxPools, FlyPool, GosCx, GosCxParty, GosCxSolo, Grinmint, Hashcryptos, Hashpool, HashVault, HeroMiners, Hiveon, Icemining, LeafPool, LuckPool, LuckyPool, Luxor, Minafacil, Minerpool, MinerRocks, Minexmr, MiningDutch, MiningDutchCoins, MiningPoolHub, MiningPoolHubCoins, MiningPoolOvh, MiningRigRentals, Mintpond, MoneroOcean, Nanopool, NiceHash, NLpool, Poolin, Poolium, PoolSexy, ProHashing, Ravenminer, RPlant, SeroPool, SoloPool, Sunpool, SuprNova, ToncoinPool, TonPool, TONWhales, unMineable, UUpool, WhatToMine, WoolyPooly, WoolyPoolySolo, ZergPool, ZergPoolCoins, ZergPoolCoinsParty, ZergPoolCoinsSolo, ZergPoolParty, ZergPoolSolo, Zpool, ZpoolCoins</details>
...
<details><summary>ToncoinPool</summary> https://www.toncoinpool.io/ no auto-exchange, mining TON coin with SHA256ton, only</details>
<details><summary>TonPool</summary> https://www.ton-pool.com/ no auto-exchange, mining TON coin with SHA256ton, only. Registration of your TON wallet via Telegram necessary.</details>
<details><summary>TONWhales</summary> https://www.tonwhales.com/ no auto-exchange, mining TON coin with SHA256ton, only. Registration of your TON wallet via Telegram necessary.</details>
