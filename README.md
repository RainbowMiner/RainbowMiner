...
- **Profit auto-switch between pools (2Miners, AHashPool, BaikalMiner, BlazePool, BlockCruncher, BlockMasters, Bsod, Cortexmint, CryptoKnight, EthashPool, Ethermine, F2pool, FairPool, FlyPool, GosCx, GrinMint, Hashcryptos, Hashpool, HashVault, HeroMiners, Icemining, LuckyPool, MinerMore, MinerRocks, MiningDutch, MiningPoolHub, [MiningRigRentals](https://www.miningrigrentals.com?ref=2598069), Mintpond, Nanopool, Nicehash, Ravenminer, SparkPool, SuprNova, UUpool, Zergpool and Zpool)**
...
<details><summary>Valid poolnames</summary>2Miners, 2MinersSolo, AHashPool, Aionmine, BaikalMine, BaikalMineSolo, BlazePool, BlockMasters, BlockMastersCoins, Bsod, BsodParty, BsodSolo, CoinFoundry, Cortexmint, CpuPool, CryptoKnight, EthashPool, Ethermine, F2pool, FairPool, FlyPool, GosCx, GosCxParty, GosCxSolo, Grinmint, Hashcryptos, Hashpool, HashVault, HeroMiners, Icemining, LuckyPool, Luxor, MinerMore, MinerRocks, Minexmr, MiningDutch, MiningDutchCoins, MiningPoolHub, MiningPoolHubCoins, MiningRigRentals, Mintpond, Nanopool, NiceHash, NLpool, PoolSexy, Ravenminer, RPlant, SparkPool, SuprNova, Tecracoin, UUpool, WhatToMine, ZergPool, ZergPoolCoins, ZergPoolCoinsParty, ZergPoolCoinsSolo, ZergPoolParty, ZergPoolSolo, Zpool</details>
