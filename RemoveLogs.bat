@echo off
cd /d %~dp0
set /p execute= This process will delete all unnecessary log files created by the miners and RainbowMiner to free up space. Are you sure you want to continue? [Y/N] 
IF /I "%execute%"=="Y" (
    ...
    if exist "Bin\Ethash-Claymore9\*_log.txt" del "Bin\Ethash-Claymore9\*_log.txt"
