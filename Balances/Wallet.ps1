...
$Wallets_Data = @(
    ...
    [PSCustomObject]@{symbol = "BTG";  match = "^G";    rpc = "https://btgexplorer.com/api/v2/address/{w}?details=basic";             address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    ...
    [PSCustomObject]@{symbol = "DGB";  match = "^D";    rpc = "https://digibyteblockexplorer.com/api/v2/address/{w}?details=basic";   address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    ...
    [PSCustomObject]@{symbol = "KMD";  match = "^R";    rpc = "https://komodoblockexplorer.com/api/v2/address/{w}?details=basic";     address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    [PSCustomObject]@{symbol = "LTC";  match = "^[LM3]"; rpc = "https://sochain.com/api/v2/get_address_balance/ltc/{w}";              address = "data.address";                     balance = "data.confirmed_balance";          received = "";                                 divisor = 1; verify = "status"; verify_value = "success"}
    [PSCustomObject]@{symbol = "QTUM"; match = "^Q";    rpc = "https://qtumblockexplorer.com/api/v2/address/{w}?details=basic";       address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    ...
    [PSCustomObject]@{symbol = "SIN";  match = "^S";    rpc = "https://blockbook.sinovate.io/api/v2/address/{w}?details=basic";       address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    ...
    [PSCustomObject]@{symbol = "VTC";  match = "^V";    rpc = "https://vtcblocks.com/api/v2/address/{w}?details=basic";               address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
    ...
    [PSCustomObject]@{symbol = "XTZ";  match = "^tz";   rpc = "https://api.tzkt.io/v1/accounts/{w}";                                  address = "address";                          balance = "balance";                         received = "";                                 divisor = 1e6}
    [PSCustomObject]@{symbol = "YEC";  match = "^s1";   rpc = "https://yecblockexplorer.com/api/v2/address/{w}?details=basic";        address = "address";                          balance = "balance";                         received = "totalReceived";                    divisor = 1e8}
