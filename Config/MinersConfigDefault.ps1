...
[PSCustomObject]@{
        ...
        "CcminerKlausT" = [PSCustomObject[]]@(
            [PSCustomObject]@{MainAlgorithm = "neoscrypt"; SecondaryAlgorithm = ""; Params = "-i 17.6"; Profile = ""}
        )
        ...
        "EnemyZealot" = [PSCustomObject[]]@(
            ...
            [PSCustomObject]@{MainAlgorithm = "x16r"; SecondaryAlgorithm = ""; Params = "-i 20"; Profile = ""}
            [PSCustomObject]@{MainAlgorithm = "x16s"; SecondaryAlgorithm = ""; Params = "-i 20"; Profile = ""}
