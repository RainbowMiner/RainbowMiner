    ...
    do {
        ...
        elseif (@("W","C","E","S","A","N") -contains $SetupType) {
            ...
            Switch ($SetupType) {
                ...
                "E" {$GlobalSetupName = "Energycost";$GlobalSetupSteps.AddRange(@("powerpricecurrency","powerprice","poweroffset","poweroffsetpercent","octopustariffcode","fixedcostperday","usepowerprice","checkprofitability")) > $null}
