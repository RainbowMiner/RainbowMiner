    ...
    do {
        ...
        elseif (@("W","C","E","S","A","N") -contains $SetupType) {
            ...
            Switch ($SetupType) {
                ...
                "E" {$GlobalSetupName = "Energycost";$GlobalSetupSteps.AddRange(@("powerpricecurrency","powerprice","poweroffset","poweroffsetpercent","powercputdp","octopustariffcode","powerpriceapi","powerpriceapivalue","fixedcostperday","usepowerprice","checkprofitability","profitabilitylevel")) > $null}
