    ...
    do {
        ...
        elseif (@("W","C","E","S","A","N") -contains $SetupType) {
            ...
            Switch ($SetupType) {
                ...
                "S" {$GlobalSetupName = "Selection";$GlobalSetupSteps.AddRange(@("poolname","minername","excludeminername","excludeminerswithfee","disabledualmining","enablecheckminingconflict","enableethashzombiemode","algorithm","excludealgorithm","disableunprofitablealgolist","excludecoinsymbol","excludecoin")) > $null}
