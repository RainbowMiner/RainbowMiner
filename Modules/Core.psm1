...
function Invoke-Core {
        ...
        try {
            ...
            $ForksDB | Where-Object {$_.active} | Foreach-Object {
                ...
                if ($_.date) {
                    ...
                    $Fork_Meets_Target = (Get-Date).ToUniversalTime() -ge $TargetTime
                } elseif ($_.height) {
    ...
    if ($Session.Timer.AddHours(-$DonateDelayHours).AddMinutes($DonateMinutes) -ge $Session.LastDonated -and $Session.AvailPools.Count -gt 0) {
        if ($Session.RoundCounter -gt 0 -and -not $Session.IsDonationRun -and -not $Session.UserConfig) {
            ...
            if (-not $DonationData -or -not $DonationData.Wallets) {$DonationData = Get-Unzip '' | ConvertFrom-Json}
        ...
        if ($Miner.Best -and ($Miner.Status -ne [MinerStatus]::Running)) {
            ...
            if ($Miner.DeviceModel -ne "CPU") {
                ...
                if ($MSIAenabled) {
                    ...
                    $m = $null
                    foreach ($m in $Global:ActiveMiners) {
                        if ($m.Best -and $m.MSIAprofile -ne $null -and $m.MSIAprofile -gt 0) {
...
function Update-Rates {
    ...
    try {
        ...
        if ($NewCoinbase.BTC) {
            $NewCoinbase.PSObject.Properties | Where-Object {($_.Name -notin $WCSymbols -or $_.Name -in $BaseSymbols) -and $_.Name -notin $Session.Config.ExcludeCurrencyRateFromCoinbase} | Foreach-Object {$NewRates[$_.Name] = [Double]$_.Value}
        }
    } catch {}
