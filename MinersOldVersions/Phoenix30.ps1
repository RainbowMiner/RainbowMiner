...
$Path = ".\Bin\Ethash-Phoenix30\PhoenixMiner.exe"
...
if (-not $Devices.NVIDIA -and -not $Devices.AMD -and -not $Devices -and -not $Config.InfoOnly) {return} # No GPU present in system
