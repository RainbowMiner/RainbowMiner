...
$Path = ".\Bin\NVIDIA-enemyz121a\z-enemy.exe"
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.21a-enemyzealot/z-enemy.1-21a-cuda9.2_x64.zip"
