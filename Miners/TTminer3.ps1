...
if ($IsLinux) {
    $Path = ".\Bin\NVIDIA-TTminer3\TT-Miner"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.0.2-ttminer/TT-Miner-3.0.2.tar.xz"
} else {
    $Path = ".\Bin\NVIDIA-TTminer3\TT-Miner.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.0.2-ttminer/TT-Miner-3.0.2.zip"
}
