...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v16.0.0-bminer/bminer-v16.0.0-362b272-amd64.tar.xz"
} else {
    $Path = ".\Bin\GPU-BMiner\bminer.exe"
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v16.0.0-bminer/bminer-lite-v16.0.0-362b272-amd64.zip"
}
$Version = "16.0.0"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{MainAlgorithm = "cuckaroo29m";  SecondaryAlgorithm = ""; NH = $true;  MinMemGb = 4; MinMemGbW10 = 6; Params = "--fast"; DevFee = 2.0; Vendor = @("NVIDIA"); ExtendInterval = 2; Penalty = 0; NoCPUMining = $true} #" -nofee" #Cuckaroom29/GRIN
