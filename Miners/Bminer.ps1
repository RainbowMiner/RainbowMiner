...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v15.8.7-bminer/bminer-lite-v15.8.7.7z"
}
$Version = "15.8.7"
					...
					if ($SecondAlgorithm -eq '') {
						...
						[PSCustomObject]@{
							...
							HashRates      = [PSCustomObject]@{
								                "$MainAlgorithm_Norm" = $Session.Stats."$($Miner_Name)_$($MainAlgorithm_Norm_0)_HashRate".Week
