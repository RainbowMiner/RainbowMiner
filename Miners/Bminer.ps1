...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v15.5.3-bminer/bminer-v15.5.3-747d98e-amd64.tar.xz"
} else {
    $Path = ".\Bin\Equihash-BMiner\bminer.exe"
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v15.5.3-bminer/bminer-lite-v15.5.3-747d98e-amd64.zip"
}
