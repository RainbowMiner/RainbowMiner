...
$URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v14.1.0-bminer/bminer-lite-v14.1.0-373029c-amd64.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "cuckaroo29";   SecondaryAlgorithm = ""; MinMemGb = 8; Params = ""; DevFee = 2.0; Vendor = @("NVIDIA"); ExtendInterval = 2; Penalty = 0} #" -nofee" #Beam
...
foreach ($Miner_Vendor in @("AMD","NVIDIA")) {
	$Session.DevicesByTypes.$Miner_Vendor | Where-Object Type -eq "GPU" | Where-Object {$_.Vendor -ne "NVIDIA" -or $Cuda} | Select-Object Vendor, Model -Unique | ForEach-Object {
        ...
        $Commands | Where-Object {$_.Vendor -icontains $Miner_Vendor} | ForEach-Object {
            ...
            if (($Pools.$MainAlgorithm_Norm.Host -or $MainAlgorithm -eq "equihash1445") -and $Miner_Device -and ($MainAlgorithm_Norm -ne "Equihash25x5" -or $Pools.$MainAlgorithm_Norm.Name -notmatch "nicehash")) {
