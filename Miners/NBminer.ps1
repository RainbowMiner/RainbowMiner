...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v33.2-nbminer/NBMiner_33.2_Linux.tgz"
} else {
    $Path = ".\Bin\GPU-NBMiner\nbminer.exe"
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v33.2-nbminer/NBMiner_33.2_Win.zip"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "Octopus";      SecondaryAlgorithm = ""; Params = "-a octopus";       NH = $true; MinMemGb = 6;   DevFee = 2.0; Vendor = @("NVIDIA");       ExtendInterval = 2; Penalty = 0; NoCPUMining = $false} #Octopus/Conflux
