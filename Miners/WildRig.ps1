...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.17.3-wildrig/wildrig-multi-linux-0.17.3-beta.tar.gz"
} else {
    $Path = ".\Bin\AMD-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.17.3-wildrig/wildrig-multi-windows-0.17.3-beta.7z"
}
