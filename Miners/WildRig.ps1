...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.46.5-wildrigmulti/wildrig-multi-linux-0.46.5.tar.gz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.46.5-wildrigmulti/wildrig-multi-windows-0.46.5.zip"
}
