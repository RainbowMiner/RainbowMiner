...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.48.6-wildrigmulti/wildrig-multi-linux-0.48.6.tar.gz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.48.6-wildrigmulti/wildrig-multi-windows-0.48.6.zip"
}
