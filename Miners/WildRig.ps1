...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.42.1-wildrigmulti/wildrig-multi-linux-0.42.1.tar.xz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.42.1-wildrigmulti/wildrig-multi-windows-0.42.1.zip"
}
