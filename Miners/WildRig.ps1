...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.48.7-wildrigmulti/wildrig-multi-linux-0.48.7.tar.gz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.48.7-wildrigmulti/wildrig-multi-windows-0.48.7.zip"
}
