...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.31.7-wildrigmulti/wildrig-multi-linux-0.31.7.tar.xz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.31.7-wildrigmulti/wildrig-multi-windows-0.31.7.7z"
}
