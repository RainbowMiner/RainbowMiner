...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.47.4-wildrigmulti/wildrig-multi-linux-0.47.4.tar.gz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.47.4-wildrigmulti/wildrig-multi-windows-0.47.4.zip"
}
