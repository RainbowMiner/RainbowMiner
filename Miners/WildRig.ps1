...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.49.9-wildrigmulti/wildrig-multi-linux-0.49.9.tar.gz"
} else {
    $Path = ".\Bin\GPU-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.49.9-wildrigmulti/wildrig-multi-windows-0.49.9.zip"
}
