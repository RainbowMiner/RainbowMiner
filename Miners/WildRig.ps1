...
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.15.2-wildrig/wildrig-multi-windows-0.15.2-beta.7z"
...
$Session.DevicesByTypes.AMD | Select-Object Vendor, Model -Unique | ForEach-Object {
    ...
    $Commands | ForEach-Object {
        ...
        if ($Pools.$Algorithm_Norm.Host -and $Miner_Device) {
            $Params = $_.Params[$Miner_Params]
            if ($Miner_GPU -eq "Gfx900" -or $Miner_Model -match "VEGA") {$Params = $Params -replace "threads 3","threads 2"}
