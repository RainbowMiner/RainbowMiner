...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.16.4-wildrig/wildrig-multi-linux-0.16.4-beta.tar.gz"
} else {
    $Path = ".\Bin\AMD-WildRig\wildrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.16.4-wildrig/wildrig-multi-windows-0.16.4-beta.7z"
}
