...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.4.2-srbminermulti/SRBMiner-Multi-3-4-2-Linux.tar.gz"
} else {
    $Path = ".\Bin\ANY-SRBMinerMulti\SRBMiner-MULTI.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.4.2-srbminermulti/SRBMiner-Multi-3-4-2-win64.zip"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "pearlhash"        ;              Params = ""; Fee = 2.00;               Vendor = @("AMD","NVIDIA"); ExcludePoolName = "84.32.220.219|129.226.55.135"; ExcludeCompute = @("Volta","Pascal","RDNA4","RDNA3","RDNA1","GCN51","GCN50","8.0","10.3"); NoAutoTune = $true} #PearlHash/PRL
