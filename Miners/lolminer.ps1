...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "";      WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "ASF";   WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "BTCZ";  WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "BTG";   WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "HEPTA"; WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "LTZ";   WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "SAFE";  WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x5"; Coin = "XSG";   WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x7"; Coin = "SCASH"; WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Equihash24x7"; Coin = "ZER";   WorkBatch = ""; MinMemGB = 2; Params = ""; Fee=2} #Equihash 144,5
)
