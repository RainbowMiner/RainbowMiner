...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.9.5-lolminer/lolMiner_v0951_Lin64.tar.gz"
} else {
    $Path = ".\Bin\Equihash-lolMiner\lolMiner.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.9.5-lolminer/lolMiner_v0951_Win64.zip"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "Cuckaroom29";     MinMemGB = 4; MinMemGBWin10 = 6; Params = "--coin GRIN-C29M"; Fee=1; ExtendInterval = 2; Vendor = @("AMD"); NH = $true} #Cuckarood29
