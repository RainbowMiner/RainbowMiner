...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.98-lolminer/lolMiner_v1.98a_Lin64.tar.gz"
} else {
    $Path = ".\Bin\GPU-lolMiner\lolMiner.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.98-lolminer/lolMiner_v1.98a_Win64.zip"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "Octopus";         DAG = $true; MinMemGb = 4;   Params = "--algo OCTOPUS";                          Pers=$false; Fee=2; ExtendInterval = 2; Vendor = @("AMD","NVIDIA"); ZombieMode = @("NVIDIA")} #Octopus/CTXC
