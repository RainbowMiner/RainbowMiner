...
if ($IsLinux) {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-teamblack/TeamBlackMiner_1_45_Ubuntu_18_04_Cuda_11_5.tar.xz"
            Cuda = "11.5"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-teamblack/TeamBlackMiner_1_45_Ubuntu_18_04_Cuda_11_4.tar.xz"
            Cuda = "11.4"
        }
    )
} else {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-teamblack/TeamBlackMiner_1_45_cuda_11_5.7z"
            Cuda = "11.5"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-teamblack/TeamBlackMiner_1_45_cuda_11_4.7z"
            Cuda = "11.4"
        }
    )
}
