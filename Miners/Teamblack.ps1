...
if ($IsLinux) {
    ...
    $UriCuda = @(
        ...
        #},
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.88-teamblack/TeamBlackMiner_1_88_Ubuntu_18_04_Cuda_11_6.tar.xz"
            Cuda = "11.6"
        }
    )
} else {
    ...
    $UriCuda = @(
        ...
        #},
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.88-teamblack/TeamBlackMiner_1_88_cuda_11_6.7z"
            Cuda = "11.6"
        }
    )
}
