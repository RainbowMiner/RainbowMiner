...
if ($IsLinux) {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.95-teamblack/TeamBlackMiner_1_95_Ubuntu_18_04_Cuda_12.tar.xz"
            Cuda = "12.0"
        }
    )
} else {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.95-teamblack/TeamBlackMiner_1_95_cuda_12.7z"
            Cuda = "12.0"
        }
    )
}
