...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.4-cpuminerverium/cpuminerverium_1.4_linux_x64_O2_GCC7.zip"
} else {
    $Path = ".\Bin\CPU-Verium\cpuminer.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.4-cpuminerverium/cpuminerverium_1.4_windows_x64_O2_GCC7.7z"
}
...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "scryptn2"; Params = "$($f=$Global:GlobalCPUInfo.Features;$(if($f.avx2 -and $f.sha -and $f.aes){'--ryzen'}))"} #Scryptn2/Verium
)
