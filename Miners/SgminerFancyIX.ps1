...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.8.1-fancyix/sgminer-fancyIX-linux-amd64-0.8.1.tar.gz"
} else {
    $Path = ".\Bin\AMD-FancyIX\sgminer.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.8.1-fancyix/sgminer-fancyIX-win64-0.8.1.zip"
}
