...
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.28-gminer/gminer_1_28_minimal_windows64.zip"
...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "Aeternity";    MinMemGB = 6; Params = "--algo aeternity"; ExtendInterval = 2; Penalty = 0; NoCPUMining = $true} #Equihash Cuckoo29/Aeternity
    [PSCustomObject]@{MainAlgorithm = "Cuckaroo29";   MinMemGB = 6; Params = "--algo grin29"; ExtendInterval = 2; Penalty = 0; NoCPUMining = $true} #Equihash Cuckaroo29/GRIN    
