...
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.15-gminer/gminer_1_15_minimal_windows64.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "Equihash1505"; MinMemGB = 4; Params = "--algo 150_5"} #Equihash 150,5
