...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v2.80-gminer/gminer_2_80_linux64.tar.xz"
} else {
    $Path = ".\Bin\GPU-Gminer\miner.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v2.80-gminer/gminer_2_80_windows64.zip"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{MainAlgorithm = "Ethash";          DAG = $true; MinMemGb = 3;                     Params = "--algo ethash --dalgo ton";     Vendor = @("NVIDIA");       ExtendInterval = 2; Fee = 1.50; ExcludePoolName = ""; SecondaryAlgorithm = "SHA256ton"} #Ethash + SHA256ton
    ...
    #[PSCustomObject]@{MainAlgorithm = "EthashLowMemory"; DAG = $true; MinMemGb = 2;                     Params = "--algo ethash --dalgo ton";     Vendor = @("NVIDIA");       ExtendInterval = 2; Fee = 1.50; ExcludePoolName = ""; SecondaryAlgorithm = "SHA256ton"} #Ethash for low memory coins + SHA256ton
