...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-gminer/gminer_1_45b_linux64.tar.xz"
} else {
    $Path = ".\Bin\NVIDIA-Gminer\miner.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.45-gminer/gminer_1_45b_windows64.zip"
}
