...
$Path = ".\Bin\CryptoNight-FireIceFH\xmr-stak.exe"
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v2.6.0-fireicefreehaven/xmr-stak-2.6.0-freehaven.7z"
$Port = "337{0:d2}"
$ManualUri = "https://github.com/killmak/xmr-stak/releases"
$DevFee = 0.0
$Cuda = "10.0"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "cryptonight_freehaven";   Threads = 1; MinMemGb = 2; Params = ""} #CryptoNightFreeHaven
