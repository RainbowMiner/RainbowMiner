...
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v8-ccminerspmodskunk/ccminer-skunkhash-sp-mod_v8.7z"
$Port = "112{0:d2}"
$DevFee = 0.0
$Cuda = "7.5"
...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "skunk"; Params = ""; ExtendInterval = 1} #Skunk
)
...
$Session.DevicesByTypes.NVIDIA | Select-Object Vendor, Model -Unique | Where-Object Model -notmatch "GTX20\d{2}" | ForEach-Object {
