...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.12.3-jayddee/cpuminer-opt-3.12.3-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.12.3-jayddee/cpuminer-opt-3.12.3-windows.zip"
}
