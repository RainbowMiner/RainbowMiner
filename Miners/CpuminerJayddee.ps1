...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.5-jayddee/cpuminer-opt-23.5-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.5-jayddee/cpuminer-opt-23.5-windows.zip"
}
