...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.6-jayddee/cpuminer-opt-23.6-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.6-jayddee/cpuminer-opt-23.6-windows.zip"
}
