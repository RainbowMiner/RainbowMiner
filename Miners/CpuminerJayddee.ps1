...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.10-jayddee/cpuminer-opt-23.10-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.10-jayddee/cpuminer-opt-23.10-windows.zip"
}
