...
if ($IsLinux) {
    if ($Global:GlobalCPUInfo.Vendor -eq "ARM" -or $Global:GlobalCPUInfo.Features.ARM) {
        if ($Global:GlobalCPUInfo.Architecture -eq 8) {
            ...
            $Uri  = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.3-jayddee/cpuminer-opt-25.3fix-arm.7z"
        ...
        $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.3-jayddee/cpuminer-opt-25.3fix-linux.7z"
    }
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.3-jayddee/cpuminer-opt-25.3-windows.zip"
}
