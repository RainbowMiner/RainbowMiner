...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.8-jayddee/cpuminer-opt-23.8-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.8-jayddee/cpuminer-opt-23.8-windows.zip"
}
