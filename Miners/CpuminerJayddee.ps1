...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.21.0-jayddee/cpuminer-opt-3.21.0-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.21.0-jayddee/cpuminer-opt-3.21.0-windows.zip"
}
