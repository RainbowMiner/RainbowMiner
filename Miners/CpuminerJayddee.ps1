...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.9.8.1-jayddee/cpuminer-opt-3.9.8.1-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.9.8.1-jayddee/cpuminer-opt-3.9.8.1-windows.zip"
}
