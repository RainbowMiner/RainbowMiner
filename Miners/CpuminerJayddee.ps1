...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.19.0-jayddee/cpuminer-opt-3.19.0-linux.7z"
    $Version = "3.19.0"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.19.1-jayddee/cpuminer-opt-3.19.1-windows.zip"
    $Version = "3.19.1"
}
