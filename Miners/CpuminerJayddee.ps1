...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.20.0-jayddee/cpuminer-opt-3.20.0-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.20.0-jayddee/cpuminer-opt-3.20.0-windows.zip"
}
