...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.15.3-jayddee/cpuminer-opt-3.15.3-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.15.3-jayddee/cpuminer-opt-3.15.3-windows.zip"
}
