...
if ($IsLinux) {
    if ($Global:GlobalCPUInfo.Vendor -eq "ARM" -or $Global:GlobalCPUInfo.Features.ARM) {
        if ($Global:GlobalCPUInfo.Architecture -eq 8) {
            ...
            $Uri  = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.5-jayddee/cpuminer-opt-25.5-arm.7z"
        ...
        $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.5-jayddee/cpuminer-opt-25.5-gc11-linux.7z"
    }
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v25.5-jayddee/cpuminer-opt-25.5-windows.zip"
}
