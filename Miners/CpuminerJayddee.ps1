...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.12.0.1-jayddee/cpuminer-opt-3.12.0.1-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.12.0.1-jayddee/cpuminer-opt-3.12.0.1-windows.zip"
}
