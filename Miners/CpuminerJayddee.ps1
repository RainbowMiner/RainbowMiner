...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.9-jayddee/cpuminer-opt-23.9-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v23.9-jayddee/cpuminer-opt-23.9-windows.zip"
}
