...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.10.1-jayddee/cpuminer-opt-3.10.1-linux.7z"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.10.1-jayddee/cpuminer-opt-3.10.1-windows.zip"
}
