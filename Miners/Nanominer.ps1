...
if ($IsLinux) {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.3.13-nanominer/nanominer-linux-3.3.13-cuda11.tar.gz"
            Cuda = "11.1"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.3.13-nanominer/nanominer-linux-3.3.13.tar.gz"
            Cuda = "10.0"
        }
    )
} else {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.3.13-nanominer/nanominer-windows-3.3.13-cuda11.zip"
            Cuda = "11.1"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.3.13-nanominer/nanominer-windows-3.3.13.zip"
            Cuda = "10.0"
        }
    )
}
