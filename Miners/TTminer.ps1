...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.3-ttminer/TT-Miner-5.0.3.zip"
    $Version = "5.0.3"
}
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "KAWPOW"        ; DAG = $true; MinMemGB = 3;   Params = "-A PROGPOW%CUDA% -coin RVN";        ExtendInterval = 2; ExcludePoolName = "^MiningPoolHub"} #KAWPOW (RVN)
    ...
    [PSCustomObject]@{MainAlgorithm = "PROGPOW"       ; DAG = $true; MinMemGB = 3;   Params = "-A PROGPOW%CUDA% -coin EPIC";       ExtendInterval = 2; Coins = @("EPIC"); ExcludePoolName = "^Nicehash"} #ProgPoW (only EPIC left)
