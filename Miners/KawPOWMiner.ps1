...
if ($IsLinux) {
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.2.1-kawpowminer/kawpowminer-ubuntu18-1.2.1.zip"
            Cuda = "10.2"
        }
    )
    #https://github.com/RainbowMiner/miner-binaries/releases/download/v1.2.1-kawpowminer/kawpowminer-ubuntu16-1.2.1.zip
} else {
    $Path = ".\Bin\GPU-KawPOWMiner\kawpowminer.exe"
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v1.2.1-kawpowminer/kawpowminer-windows-1.2.1.zip"
            Cuda = "10.2"
        }
    )
}
