...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.6.0-xmrig/xmrig-5.6.0-xenial-cuda10_1-x64.7z"
    $CudaLib = "libxmrig-cuda.so"
    $DevFee = 0.0
} else {
    $Path = ".\Bin\ANY-Xmrig\xmrig.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.6.0-xmrig/xmrig-5.6.0-msvc-cuda10_1-win64.7z"
