...
if ($IsLinux) {
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-bionic-cuda11_0-x64.7z"
            Cuda = "11.0"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-bionic-cuda10_2-x64.7z"
            Cuda = "10.2"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-bionic-cuda10_1-x64.7z"
            Cuda = "10.1"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-bionic-cuda10_0-x64.7z"
            Cuda = "10.0"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-bionic-cuda9_2-x64.7z"
            Cuda = "9.2"
        }
    )
    ...
    $UriCuda = @(
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda11_0-win64.7z"
            Cuda = "11.0"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda10_2-win64.7z"
            Cuda = "10.2"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda10_1-win64.7z"
            Cuda = "10.1"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda10_0-win64.7z"
            Cuda = "10.0"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda9_2-win64.7z"
            Cuda = "9.2"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda9_1-win64.7z"
            Cuda = "9.1"
        },
        [PSCustomObject]@{
            Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v6.3.4-xmrig/xmrig-6.3.4-msvc-cuda9_0-win64.7z"
            Cuda = "9.0"
        }
    )
