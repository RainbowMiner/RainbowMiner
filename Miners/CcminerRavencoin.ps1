...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "x16r"; Params = "-N 10 --donate 0"; ExtendInterval = 10; FaultTolerance = 0.5; HashrateDuration = "Day"} #X16R RavenCoin
    #[PSCustomObject]@{MainAlgorithm = "x16s"; Params = ""} #X16S PigeonCoin
)
