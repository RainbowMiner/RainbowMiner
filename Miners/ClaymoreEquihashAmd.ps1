    ...
    $Commands | ForEach-Object {
        ...
        if ($Pools.$Algorithm_Norm.Host -and $Miner_Device) {
            ...
            [PSCustomObject]@{
                ...
                Path = $Path
                Arguments = "-r -1 -mport -$($Miner_Port) -zpool $($Pools.$Algorithm_Norm.Host):$($Pool_Port) -zwal $($Pools.$Algorithm_Norm.User) -zpsw $($Pools.$Algorithm_Norm.Pass) -allpools 1 -di $($DeviceIDsAll) -logfile $($Miner_Port)_log.txt $($_.Params)"
