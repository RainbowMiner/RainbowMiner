...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "cuckaroo29"; MinMemGb = 6; Params = ""; DevFee = 2.0; ExtendInterval = 2; FaultTolerance = 0.3; Penalty = 0; Vendor = @("AMD")} #GRIN/Cuckaroo29
    #[PSCustomObject]@{MainAlgorithm = "cuckaroo29"; MinMemGb = 6; Params = ""; DevFee = 2.0; ExtendInterval = 2; FaultTolerance = 0.3; Penalty = 0; Vendor = @("NVIDIA")} #GRIN/Cuckaroo29
)
