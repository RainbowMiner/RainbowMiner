...
$ManualURI = "https://bitcointalk.org/index.php?topic=5305046.0"
$Port = "200{0:d2}"
$Version = "2.5"
...
if ($IsLinux) {
    #$Path = ".\Bin\Ethash-ClaymoreMoreEpoch\ethdcrminer64"
    #$UriCuda = @(
    #    [PSCustomObject]@{
    ...
    $Path = ".\Bin\Ethash-ClaymoreMoreEpoch\EthDcrMiner64.exe"
    $UriCuda = @(
        [PSCustomObject]@{            
            Uri  = "https://github.com/RainbowMiner/miner-binaries/releases/download/v2.5-jamclaymore/claymoredual_justaminer_v15.0_2.5_win_cuda10.7z"
            Cuda = "10.0"
        },
        [PSCustomObject]@{
            Uri  = "https://github.com/RainbowMiner/miner-binaries/releases/download/v2.5-jamclaymore/claymoredual_justaminer_v15.0_2.5_win_cuda8.7z"
            Cuda = "8.0"
        }
    )
}
