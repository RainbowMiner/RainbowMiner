...
if ($IsLinux) {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.4.1-noncerpro/noncerpro-cuda-linux-3.4.1.tar.gz"
} else {
    $Path = ".\Bin\NVIDIA-NoncerPro\noncerpro.exe"
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v3.4.1-noncerpro/noncerpro-cuda-win64-3.4.1.zip"
}
...
$Global:DeviceCache.DevicesByTypes.NVIDIA | Select-Object Vendor, Model -Unique | ForEach-Object {
    $First = $true
    $Miner_Model = $_.Model
    $Miner_Device = $Global:DeviceCache.DevicesByTypes."$($_.Vendor)" | Where-Object {$_.Model -eq $Miner_Model -and $_.OpenCL.Architecture -in @("Pascal","Turing","Other")}
