...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{MainAlgorithm = "kawpow";          DAG = $true; MinMemGb = 3;                     Params = "";     Vendor = @("AMD","NVIDIA"); ExtendInterval = 3; ExcludePoolName = "prohashing|miningrigrentals"; ExcludeCoinSymbol = @("NEOX")} #KawPow
    [PSCustomObject]@{MainAlgorithm = "neox";            DAG = $true; MinMemGb = 1;                     Params = "";     Vendor = @("AMD","NVIDIA"); ExtendInterval = 3; ExcludePoolName = "prohashing|miningrigrentals"; CoinSymbol = @("NEOX")} #NEOXA/KawPow
