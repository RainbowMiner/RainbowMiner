...
$Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v0.3.8-teamred/teamredminer-v0.3.8-win.zip"
$Port = "409{0:d2}"
    ...
    $Commands | ForEach-Object {        
        ...
        if ($Pools.$Algorithm_Norm.Host -and $Miner_Device) {
            ...
            [PSCustomObject]@{
                ...
                Path      = $Path
                Arguments = "-a $($_.MainAlgorithm) -d $($DeviceIDsAll) -o $($Pools.$Algorithm_Norm.Protocol)://$($Pools.$Algorithm_Norm.Host):$($Pool_Port) -u $($Pools.$Algorithm_Norm.User) -p $($Pools.$Algorithm_Norm.Pass) --api_listen=$($Miner_Port) --platform=$($Miner_PlatformId) $($_.Params)"
