...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{MainAlgorithm = "Equihash-BTG"; Params = "--algo 144_5 --pers BgoldPoW"} #Equihash 144,5
    [PSCustomObject]@{MainAlgorithm = "Zerocurrency"; Params = "--algo 192_7 --pers ZERO_PoW"} #Equihash 192,7
