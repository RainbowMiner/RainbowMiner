...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.33a-rplant/cpuminer-rplant-5.0.33a-linux.tar.gz"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.33a-rplant/cpuminer-rplant-5.0.33a-win.zip"
}
