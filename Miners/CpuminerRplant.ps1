...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.14-rplant/cpuminer-rplant-5.0.14-linux.tar.gz"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.14-rplant/cpuminer-rplant-5.0.14-win.zip"
}
