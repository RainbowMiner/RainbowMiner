...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.5-rplant/cpuminer-rplant-5.0.5-linux.tar.gz"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.5-rplant/cpuminer-rplant-5.0.5-win.zip"
}
