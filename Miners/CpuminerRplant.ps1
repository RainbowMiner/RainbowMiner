...
if ($IsLinux) {
    ...
    $URI = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.4-rplant/cpuminer-rplant-5.0.4-linux.tar.gz"
} else {
    ...
    $Uri = "https://github.com/RainbowMiner/miner-binaries/releases/download/v5.0.4-rplant/cpuminer-rplant-5.0.4-win.zip"
}
