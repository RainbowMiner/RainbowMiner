...
function Invoke-Core {
    ...
    $Pools_Hashrates = @{}
    $Session.AllPools | Select-Object Algorithm,Hashrate | Group-Object -Property Algorithm | Foreach-Object {$Pools_Hashrates[$_.Name] = ($_.Group.Hashrate | Measure-Object -Maximum).Maximum;if (-not $Pools_Hashrates[$_.Name]) {$Pools_Hashrates[$_.Name]=1}}
