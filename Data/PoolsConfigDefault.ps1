[PSCustomObject]@{
        ...
        "MiningRigRentals" = [PSCustomObject]@{
            Fields=[PSCustomObject]@{
                        ...
                        DiffMessageTime="30m"
                        DiffMessage="Dear renter, your pool's share difficulty is %currentdiff% and it should be between %mindiff% and %maxdiff% to get the advertised hashrate. If the difficulty is too high, the result will be eratic but accurate for long rental times, if the difficulty is too low, the final hashrate will be too low as well." 
                        PoolOfflineTime="3m"
