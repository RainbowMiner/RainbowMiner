[PSCustomObject]@{
    ...
    Algorithm = @("aergo","allium","bcd","bitcore","blake2s","c11","cryptonightswap","cryptonightheavy","cryptonightv8","equihash","equihash144","equihash192","ethash","hex","hmq1725","keccak","keccakc","lyra2z","m7m","pascal","phi","phi2","poly","renesis","skein","skunk","sonoa","timetravel","tribus","x16r","x16s","x17","x21s","x22i","xevan","yescrypt","yescryptr16","yescryptr32","yespower")
